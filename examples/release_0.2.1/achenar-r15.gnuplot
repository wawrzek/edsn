...
set title "Star Systems in distance of 15 Light Years from Achenar" font ",20"

splot for [n = 1 : 3.0 ] \
  n * fx(v), n * fy(v), fz lt 3 lw 1 lc "gray70" notitle, \
  'achenar-r15.3d.dat' using 2:3:4:1 with labels right offset -1,-1,-1 font ",13" notitle, \
